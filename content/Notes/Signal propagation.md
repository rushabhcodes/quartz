...
2. Reflection
	- Happens when signals bounce oƯ large surfaces like walls, buildings, or the ground.
...
3. Refraction
	- Bending of the signal as it passes through materials with diƯerent densities (e.g., from air to glass or air layers with diƯerent temperatures).
...
5. Multipath Propagation
	- A combination of reflection, scattering, and diƯraction.
