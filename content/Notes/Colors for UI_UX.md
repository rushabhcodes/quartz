...
![[Pasted image 20250626020016.png]]
...
- **WCAG Guidelines for Accessibility**:
    ...
    • Tools like [**Contrast Checker** (WebAIM)](https://webaim.org/resources/contrastchecker/) can help ensure your design meets accessibility standards.
    

### 60-30-10 Rule

![[Pasted image 20250626020136.png]]
...
- [RealtimeColors](https://www.realtimecolors.com/) - Realtime Colors preview with your chosen palette.
- [UIColors](https://uicolors.app/create) - Tailwind CSS Color Generator
- [Huemint](https://huemint.com/) - Huemint uses machine learning to generate unique color schemes for your brand.